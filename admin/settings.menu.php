...
function shiftnav_menu_item_settings_panel()
{
	...
	<div class="shiftnav-js-check">
		...
		<div class="shiftnav-js-check-details">
			<p>
				...
				in order to allow ShiftNav to run.
			</p>
		</div>
	</div>
	<div class="shiftnav-menu-item-settings-wrapper">
		...
		<div class="shiftnav-menu-item-settings-topper">
			...
			<?php if (!SHIFTNAV_PRO): ?><a target="_blank" href="https://shiftnav.io/pro/" class="shiftnav-up-link"><i
						class="fa fa-rocket"></i> Go Pro</a><?php endif; ?>
		</div>
			...
			<div class="shiftnav-menu-item-panel-info">
				...
				<ul class="shiftnav-menu-item-tabs">
					<?php foreach ($panels as $panel_id => $panel): ?>
						<li class="shiftnav-menu-item-tab"><a href="#"
								data-shiftnav-tab="<?php echo $panel_id; ?>"><?php echo $panel['title']; ?></a></li>
					<?php endforeach; ?>
...
function shiftnav_show_menu_item_setting($setting)
{
	...
	if (isset($setting['pro_only']) && $setting['pro_only']) {
		echo '<a class="shiftnav-upgrade-link" target="_blank" href="https://shiftnav.io/pro/">Upgrade to ShiftNav Pro</a> to use this feature.';
		return;
	}
			...
			<div class="shiftnav-icon-settings-wrap">
				...
				<div class="shiftnav-icons shift-clearfix">
					...
					<?php foreach ($ops as $_val => $data):
						if ($_val == '')
							continue; ?>
						<span class="shiftnav-icon-wrap" title="<?php echo $data['title']; ?>"
							data-shiftnav-search-terms="<?php echo strtolower($data['title']); ?>"><i
								class="shiftnav-icon <?php echo $_val; ?>" data-shiftnav-icon="<?php echo $_val; ?>"></i></span>
					<?php endforeach; ?>
					<span class="shiftnav-icon-wrap shiftnav-remove-icon" title="Remove Icon"><i class="shiftnav-icon"
							data-shiftnav-icon="">Remove Icon</i></span>
				</div>
				<select <?php echo $class; ?> 			<?php echo "$name $data_setting"; ?>>
					<?php foreach ($ops as $_val => $data): ?>

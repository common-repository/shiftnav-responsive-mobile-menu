...
function shiftnav_pro_link()
{
	...
	<div class="shiftnav_pro_button_container">
		<a target="_blank"
			href="https://shiftnav.io/pro/?utm_source=shiftnav_free&utm_medium=plugin&utm_content=settings_gopro_button&utm_campaign=shiftnav_pro"
			class="shiftnav_pro_button"><i class="fa fa-rocket"></i> Go Pro</a>
	</div>
	<?php
}
if (!SHIFTNAV_PRO)
	add_action('shiftnav_settings_before', 'shiftnav_pro_link');

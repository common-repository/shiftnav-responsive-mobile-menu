    ...
    final class ShiftNav
    {
        ...
        private function setup_constants()
        {
            ...
            if (!defined('SHIFTNAV_BASENAME'))
                define('SHIFTNAV_BASENAME', plugin_basename(SHIFTNAV_FILE));

            if (!defined('SHIFTNAV_BASEDIR')) {
                define('SHIFTNAV_BASEDIR', dirname(plugin_basename(SHIFTNAV_FILE)));
            }

            // Plugin Folder URL
            if (!defined('SHIFTNAV_URL'))
                define('SHIFTNAV_URL', plugin_dir_url(SHIFTNAV_FILE));

            // Plugin Folder Path
            if (!defined('SHIFTNAV_DIR'))
                define('SHIFTNAV_DIR', plugin_dir_path(SHIFTNAV_FILE));
        ...
        private function includes()
        {
            ...
            if (SHIFTNAV_PRO)
                require_once SHIFTNAV_DIR . 'pro/shiftnav.pro.php';
        ...
        {
            if (self::$settings_defaults == null)
                self::set_defaults(shiftnav_get_settings_fields());
